...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gulp-iconify/node_modules/gulp-iconify/lib/custom-gulp-sass.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-gulp-iconify">npmtest-gulp-iconify (v2017.4.24)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-gulp-iconify/node_modules/gulp-iconify/lib/custom-gulp-sass.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gulp-iconify/node_modules/gulp-iconify/lib/</a> &#187; custom-gulp-sass.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        opts = assign({}, options);</span>
...
<span class="cstat-no" title="statement not covered" >                    for (sourceFileIndex = 0; sourceFileIndex &lt; sassMap.sources.length; sourceFileIndex++) {</span>
<span class="cstat-no" title="statement not covered" >                        if (sourceFileIndex !== sassMap.sources.indexOf(sassMapFile)) {</span>
<span class="cstat-no" title="statement not covered" >                            sassMap.sources[sourceFileIndex] = path.join(sassFileSrcPath, sassMap.sources[sourceFileIndex]);</span>
                        }
                    }
                }
                // Remove 'stdin' from souces and replace with filenames!
<span class="cstat-no" title="statement not covered" >                filteredSources = sassMap.sources.filter(<span class="fstat-no" title="function not covered" >function(src) {</span></span>
<span class="cstat-no" title="statement not covered" >                    if (src.indexOf('stdin') === -1) {</span>
<span class="cstat-no" title="statement not covered" >                        return src;</span>
                    }
                });
<span class="cstat-no" title="statement not covered" >                sassMap.sources = filteredSources;</span>
<span class="cstat-no" title="statement not covered" >                sassMap.sources.unshift(sassFileSrc);</span>
...
<span class="cstat-no" title="statement not covered" >            file.path = gutil.replaceExtension(file.path, '.css');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            var parts = file.path.split('/');</span>
<span class="cstat-no" title="statement not covered" >            if(parts.length) {</span>
<span class="cstat-no" title="statement not covered" >                parts[parts.length - 1] = parts[parts.length - 1].replace(/^_+/, '');</span>
<span class="cstat-no" title="statement not covered" >                file.path = parts.join('/');</span>
            }
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Thu Apr 27 2017 18:43:35 GMT+0000 (UTC)</div>
</div>
</body>
</html>
